...
namespace SEBookStore.WebApi.Controllers
{
    ...
    /// </summary>
    public sealed partial class BooksController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
