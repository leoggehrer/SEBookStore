//@CodeCopy
#if ACCOUNT_ON
using SEBookStore.Logic.Entities.Account;
using SEBookStore.Logic.Modules.Exceptions;
using SEBookStore.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEBookStore.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEBookStore.Common.Modules.ThreadSafe;
